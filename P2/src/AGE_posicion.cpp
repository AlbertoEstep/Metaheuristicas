...
void cruce(solucion &padre1, solucion &padre2, solucion &hijo1, solucion &hijo2){
  crucePosicion(padre1, padre2, hijo1, hijo2);
}
...
*/
double AGEposicion(vector<vector<double>> &m, int n, int MAX_EVALUACIONES){
...
int main(int argc, char *argv[]){
  ...
  AGEposicion(m, n_sel, MAX_EVALUACIONES); // aplico el algoritmo AGGuniforme
}
